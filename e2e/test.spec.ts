...
test.describe('Use Helia with Vue', () => {
  ...
  test('should properly initialize Helia, and add/get a file', async ({ page }) => {
    ...
    const exampleCid = 'bafkreife2klsil6kaxqhvmhgldpsvk5yutzm4i5bgjoq6fydefwtihnesa'
    ...
    await page.fill('#fetchText', exampleCid)
    await page.click('#fetchTextButton')
    const textOutput = page.locator('#fetchedtextOutput')
    await expect(textOutput).toHaveText('Hello World 101', { timeout: 2000 })
